...
const servicesRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  const servicesFeature = fastify.requireFeature('specialists.services');

  // ── GET /admin/services ───────────────────────────────────────────────────
  fastify.get('/services', { preHandler: [adminAuth, servicesFeature] }, async (req) => {
  ...
  // ── POST /admin/services ──────────────────────────────────────────────────
  fastify.post('/services', { preHandler: [adminAuth, servicesFeature] }, async (req, reply) => {
  ...
  fastify.get('/services/:id', { preHandler: [adminAuth, servicesFeature] }, async (req, reply) => {
  ...
  fastify.patch(
    '/services/:id',
    { preHandler: [adminAuth, servicesFeature] },
    async (req, reply) => {
      const { id } = req.params as { id: string };
