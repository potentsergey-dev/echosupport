...
const specialistsRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  const specialistsFeature = fastify.requireFeature('specialists.services');

  // ── GET /admin/specialists ────────────────────────────────────────────────
  fastify.get('/specialists', { preHandler: [adminAuth, specialistsFeature] }, async (req) => {
  ...
  fastify.post(
    '/specialists',
    { preHandler: [adminAuth, specialistsFeature] },
    async (req, reply) => {
